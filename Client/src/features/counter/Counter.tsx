import { Box, Button, ButtonGroup, Card, List, ListItemText, TextField, Typography } from "@mui/material";
...
const Counter = observer(function Counter() {
  ...
  return (
    <Box display='flex' justifyContent='space-between' alignItems='flex-start'>
      <Card sx={{display:"flex", flexDirection:"column", borderRadius:3, width:'60%', mr:2}}>
      ...
      <Card sx={{display:"flex", flexDirection:"column", borderRadius:3, width: '40%', ml:2}}>
        <Box sx={{p: 3, alignItems: "center", textAlign:"center" }}>
